...
#Область СобытияФормы
	...
	Процедура ПриОткрытии(Отказ)
		...
		КонецЕсли;
		Если Не ЗначениеЗаполнено(ИмяПечатнойФормыДляАктаОРасхождениях) Тогда
			ИмяПечатнойФормыДляПриходногоОрдера = "АктОРасхожденияхПослеПеремещенияВПФ";
		КонецЕсли;
...
#Область ПрочиеПроцедурыИФункции
	...
	Процедура ОбновитьДеревоТоваровПоТабличнымЧастям()
		...
		Если ПараметрРазрешитьПриходоватьОтсутствующийВПеремещенииТовар Тогда
			...
			|	врТаблицаТоварыПлан.НоменклатураНаименование КАК НоменклатураНаименованиеПлан,
			|	врТаблицаТоварыФакт.НоменклатураНаименование КАК НоменклатураНаименованиеФакт,
			|	врПредставлениеЧисел.Строка КАК Строка
			|ИЗ
			...
			|	врТаблицаТоварыПлан.НоменклатураНаименование,
			|	врТаблицаТоварыФакт.НоменклатураНаименование,
			|	ВЫБОР
			|		КОГДА
			|		НЕ врТаблицаТоварыПлан.Номенклатура ЕСТЬ NULL
			|			ТОГДА ВЫБОР
