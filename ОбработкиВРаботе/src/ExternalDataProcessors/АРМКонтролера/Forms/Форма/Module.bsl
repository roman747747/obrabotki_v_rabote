...
Процедура ПриОткрытии(Отказ)
	...
	Заголовок = "[АРМ Контролера] на " + ИмяКомпьютера() + " [" + ИдентификаторРМ
		+ "]";
	УстановитьВидимостьДоступность();
...
Процедура КомандаПечать(Команда)
	...
	Если ЗначениеЗаполнено(ДокументПеремещение) Тогда 
		...
		Если ПечатьНаКлумбу Тогда
			...
			//
			//НапечататьДокумент(ДокументПеремещение, "ПФ_MXL_НакладнаяНаПеремещение", СтруктураДополнительныхПараметров, "ФормаОбъекта");
