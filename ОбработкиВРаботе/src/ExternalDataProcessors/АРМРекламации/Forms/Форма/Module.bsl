...
Процедура СоздатьИПровестиДокументыПоОтражениюРасхождений()
	...
	ДокОбъектПОТ.Комментарий = "Расхождения выявленные при приемке на складе рекламаций по перемещению " + ТекущийПриходныйОрдер.Распоряжение;
	...
	ДокОбъектСписание.Комментарий = "Расхождения выявленные при приемке на складе рекламаций по перемещению " + ТекущийПриходныйОрдер.Распоряжение;
	ДокОбъектСписание.ХозяйственнаяОперация = ПредопределенноеЗначение("Перечисление.ХозяйственныеОперации.СписаниеТоваров");
